...
public class AltaEmpleado extends javax.swing.JFrame {
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        // TODO add your handling code here:
        int respuesta = JOptionPane.showConfirmDialog(this, "Esta acción borrara los datos actuales. ¿Estas seguro de continuar?");
        if (respuesta == 0) { //constantes de clases
            //leer del archivo
            //subir array list actual
            // el primer elemento del array list se pondrá en el formulario
            ArchivoEmpleado persisitencia = new ArchivoEmpleado();
            JFileChooser jfc = new JFileChooser();
            jfc.showOpenDialog(this);
            persisitencia.setArchivo(jfc.getSelectedFile().getAbsolutePath());
            this.lista = persisitencia.leerEmpleados();
            this.limpiarFormulario();
            this.indice = 0;
